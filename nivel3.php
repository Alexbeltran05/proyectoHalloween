...
$imagenes = [
    ['id' => 'moltenFreddy', 'image' => 'moltenFreddy.png'],
...
<div id="startOverlay">
    ...
    <img src="imagenes/prox.png" style="width: 40%; ">
...
const jumpscares={
    'moltenFreddy':'videos/jumpscare_moltenFreddy.mp4',
...
function actualizarMovimientos(movs){
    ...
    if(movimientos===0&&juegoActivo){
        const ultimo=cartasVolteadas.length>0?cartasVolteadas[0].dataset.id:'moltenFreddy';
        gameOver(ultimo);
    }
}
